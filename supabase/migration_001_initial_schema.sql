...
-- Renamed from schema.sql during the July 2026 migration-history cleanup
-- (content unchanged) — this is the true starting point of the sequence,
-- run once by hand in the Supabase SQL Editor before any numbered
-- migration existed. Follow with seed_exercises.sql (252 exercises),
-- then migration_002 onward in order. See ../README.md for the full
