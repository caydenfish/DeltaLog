...
// Tier 1 (generic): the broad buckets that drive the heatmap and
...
// Tier 2 (detailed): the gym-colloquial middle tier ("Lats", "Front
// Delts"), each belonging to exactly one generic group. Migration_040
