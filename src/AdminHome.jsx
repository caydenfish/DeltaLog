...
export default function AdminHome({ onClose, onOpenExercises, onOpenFeedback, onSimulateNewUser, onOpenVersionHistory, onOpenRoles, onOpenSplits, onOpenUserActivity, onOpenReferralSources, onOpenBodyMapLabeler, unseenFeedbackCount, adminViewMode, onSetAdminViewMode, isCreator }) {
  return (
    <div style={{ position: "fixed", inset: 0, background: T.bg, zIndex: 25, display: "flex", justifyContent: "center", overflowY: "auto" }}>
      <div style={{ width: "100%", maxWidth: 400, minHeight: "100vh", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ padding: 16, flex: 1 }}>
          ...
          <Row onClick={onOpenBodyMapLabeler} title="Body Map Labeler" subtitle="Assign muscle names to the new body map's raw shapes" />
