...
export default function AdminHome({ onClose, onOpenExercises, onOpenFeedback, onSimulateNewUser, onOpenVersionHistory, onOpenRoles, onOpenSplits, onOpenUserActivity, onOpenReferralSources, onOpenTaxonomy, unseenFeedbackCount, adminViewMode, onSetAdminViewMode, isCreator }) {
  return (
